...
/* The simplifier class holds methods to apply Fourier-Motzkin to a set of
 * constraints, and remove rounding errors of relaxed constraints.*/
class Simplifier {
public:
  Simplifier(Conjunction &sys);
  ~Simplifier();
  Conjs get() { return ret; }
  void run();
